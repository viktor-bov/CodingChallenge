...
namespace AlloyOptimisationUtilityTests
{
    ...
    {
        public static Element Nickel { get; } = new("Ni", costCoefficient: 8.9);
        public static Element Chromium { get; } = new("Cr", costCoefficient: 14.0, creepCoefficient: 2.0911350E+16);
        public static Element Cobalt { get; } = new("Co", costCoefficient: 80.5, creepCoefficient: 7.2380280E+16);
        public static Element Niobium { get; } = new("Nb", costCoefficient: 42.5, creepCoefficient: 1.0352738E+16);
        public static Element Molybdenum { get; } = new("Mo", costCoefficient: 16.0, creepCoefficient: 8.9124547E+16);
